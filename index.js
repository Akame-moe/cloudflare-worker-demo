	...
	try{
	  ...
	  if(q){
		  ...
		  var resp = await fetch(req_url,opt);
			//return new Response(resp.body, {status: 500});
		  ...
		  resp_headers.delete('content-security-policy');
		  resp_headers.delete('content-security-policy-report-only');
		  resp_headers.delete('clear-site-data');
